<template>
    <aside class="main-sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active">
                <router-link to="/"><i class="fa fa-tachometer-alt blue"></i> <span>Dashboard</span></router-link>
            </li>
            ...
            <li class="treeview" v-if="(routesAuth.some(data => { return ['all', 'referencia.create',  'referencia_2',  'referencia_3',  'referencia_4'].includes(data) }))">
                ...
                <ul class="treeview-menu">
                    <li v-if="(routesAuth.some(data => { return ['all', 'referencia.create'].includes(data) }))">
                        <router-link to="/Referencia/Registrar"><i class="far fa-circle"></i> Registrar</router-link>
                    </li>
                    <li v-if="(routesAuth.some(data => { return ['all', 'referencia.create'].includes(data) }))">
                        <router-link to="/Referencia/Registrar"><i class="far fa-circle"></i> Panel de Referencias</router-link>
                    </li>
                    <li v-if="(routesAuth.some(data => { return ['all', 'referencia.create'].includes(data) }))">
                        <router-link to="/Referencia/Registrar"><i class="far fa-circle"></i> Reporte de Referencias</router-link>
                    </li>
                </ul>
            </li>
            ...
            <li><router-link to="/" v-on:click="logout"><i class="fa fa-power-off red"></i> <span>Salir</span></router-link></li>
