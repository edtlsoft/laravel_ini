        ...
        <div class="panel panel-widget" id="item_1">
            ...
            <div class="panel-body">
                <div class="icon-container-body">
                    ...
                    <div class="item">
                        <a class="icon-file_manager" href="./generar_rips.php"> <img src="./img/icons/rips-icon-4.png" class="img-item-panel"> </a>
                        <a class="itemTextWrapper" href="./generar_megaplano.php"> GENERAR MEGAPLANO </a>
                    </div>
